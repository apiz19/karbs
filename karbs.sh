...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/apiz19/dotfiles.git"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Kopishitam's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\nCredit to Luke, modified by me\\n-Kops" 10 60
...
dialog --title "KARBS Installation" --infobox "Installing \`basedevel\` and \`git\` for installing other software required for the installation of other programs." 5 70
installpkg curl
...
[ "$distro" = arch ] && newperms "%wheel ALL=(ALL) ALL #KARBS
